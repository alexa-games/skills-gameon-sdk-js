<p align="center">
  <img src="./media/images/gameon-alexa-logo.png">
  <br/>
...
The GameOn Alexa SDK for Node.js provides easy access to Amazon GameOn and creates higher-level methods, utilities, and examples that simplify the integration of GameOn features, like leaderboards, with Alexa skills.
...
1. Update `gameConstants.js` with the matchId, tournamentId, appBuildType, and gameApiKey
2. Build the skill and deploy to your preferred infrastructure (e.g. AWS Lambda, etc)
